...
funcao Calculadora (){
  ...
  funcao AcidentesTransito(){
    ...
    real maior_indice=0.0, menor_indice=0.0,media_car=0.0, media_acidente=0.0, indice= 0.0	
    inteiro cidade_maior_indice=0, cidade_menor_indice=0, tot_car=0, cidade_menos_car=0, soma_acidente=0,cod,qtd_carro=0,numero_vitimas=0
     ...
     //}
      ...
      se( i == 1 ){
        ...
        cidade_menos_car = cidade_menos_car + i
      ...
      escreva("\nO maior i­ndice é: ", maior_indice, " pertence a cidade ", cidade_maior_indice)
  ...
  funcao CalculaMedia(){
    ...
    result = (notas[0]+notas[1]+notas[2]+notas[3])/4
